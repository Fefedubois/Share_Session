...
class SpotsTest < ApplicationSystemTestCase
  ...
  test "creating a Spot" do
    ...
    fill_in "Adress", with: @spot.adress
    fill_in "Best tide", with: @spot.best_tide
    fill_in "Best wind", with: @spot.best_wind
    ...
    fill_in "Note", with: @spot.note
    fill_in "Photo", with: @spot.photo
    fill_in "Publish date", with: @spot.publish_date
    fill_in "User id", with: @spot.user_id_id
